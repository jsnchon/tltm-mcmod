...
@OnlyIn(Dist.CLIENT)
public class RecluseCurseParticle extends SpriteTexturedParticle {
    //https://github.com/Alex-the-666/Ice_and_Fire/blob/1.16.3/src/main/java/com/github/alexthe666/iceandfire/client/particle/ParticlePixieDust.java
    //https://github.com/Alex-the-666/Ice_and_Fire/blob/9f9f3289f0c8c2ec2d275e7586953908004024c6/src/main/java/com/github/alexthe666/iceandfire/client/particle/ParticleDragonFlame.java#L74

    private static final ResourceLocation RECLUSE_CURSE = new ResourceLocation(TheLittleThingsMod.MOD_ID, "textures/particles/recluse_curse.png");
    float curseParticleScale;

    public RecluseCurseParticle(ClientWorld worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double motX, double motY, double motZ, float scale, int minAge){
        ...
        this.curseParticleScale = this.particleScale;
    ...
    public void renderParticle(IVertexBuilder buffer, ActiveRenderInfo renderInfo, float partialTicks) {
        ...
        this.particleScale = this.curseParticleScale * scaley;
        ...
        float f5 = 0;
        float f6 = 1;
        Minecraft.getInstance().getTextureManager().bindTexture(RECLUSE_CURSE);
